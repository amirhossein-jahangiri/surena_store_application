...
// todo convert a Expansion Tile widget to a Custom Expansion Tile widget to use border radius
// todo display custom expansion tile widget
...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child: Icon(Icons.expand_more, size: widget.defaultLeadingIconSize),
    );
  }
