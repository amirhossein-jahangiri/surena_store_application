...
// todo this class for route name constants

class RouteConstants {
  static const String TABS_SCREEN_ROUTE_NAME = '/';
  static const String PRODUCT_OVERVIEW_SCREEN_ROUTE_NAME = '/product-overview';
